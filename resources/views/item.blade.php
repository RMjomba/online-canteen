                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="delivery_time" id="delivery_time" placeholder="Delivery time">
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-dialog" role="document">
                <form method="post" name="editproduct" class="editproduct" id="editproduct" enctype="multipart/form-data">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="form-group">
                            <label for="getprice" class="col-form-label">stock:</label>
                            <input type="text" class="form-control" name="getstock" id="getstock" placeholder="stock">
                        </div>
                            <div class="form-group">
...
function GetData(id) {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#getstock').val(response.ResponseData.item_stock);
